...
(function () {
  ...
  var ROUTES = [{
    ...
    arr: { icao: "LFPG", rwy: "09R",
           td:    [48.99316, 2.57006],        /* ⭐ 0823q 소로 실측 접지점 */
    ...
    legs: [
      ...
      [48.97340, 2.21478, "최종접근"],             /* 1,379m · 85° ┐ */
      [48.97876, 2.29753, "최종접근"],             /* 1,059m · 82° │ ⭐ 5.3분 동안 */
      [48.98255, 2.37180, "최종접근"],             /*   762m · 84° │   헤딩이 85° 로 고정된다 */
      [48.98580, 2.43475, "최종접근"],             /*   518m · 85° │ */
      [48.98850, 2.48462, "최종접근"],             /*   328m · 85° │ */
      [48.99087, 2.52799, "최종접근"],             /*   160m · 85° ┘ */
      [48.99316, 2.57006, "파리 · 활주로 09R"],    /* ⭐ 소로 실측 접지점 */
      ...
      try {
        ...
        if (!LOOP && route.desc && route.arr && route.arr.td) {
          ...
          if (tdKm > 0) {
            ...
            /* ⭐ 0823q — 활주 중에는 활주로 표면에 앉힌다. groundH 는 매 프레임 흔들리므로
               한 번 붙든 RWY_H 를 쓴다 — 바퀴가 오르내리지 않는다. */
            LDG = [(RWY_H !== null) ? RWY_H : groundH, Math.max(30, 250 * (runKm / runAll))];
          }
        }
