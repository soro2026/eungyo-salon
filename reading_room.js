  ...
  function cruise(route, opt) {
    ...
    function paintBody() {
      ...
      if (route.arr && tdKm < 9e8) {
        ...
        /* ⭐⭐ 0823t 플랩 — 거리에 따라 세 단계. 실물 787 은 5° → 20° → 30° 로 내린다.
           ⚠ 한 번에 안 내린다. 60km 부터 조금씩 내려야 손님이 「내려가는 중」을 본다. */
        flapSet(ARRIVED ? 30 : tdKm <= 20 ? 30 : tdKm <= 35 ? 20 : tdKm <= 60 ? 8 : 0);
